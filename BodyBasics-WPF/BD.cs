...
namespace Microsoft.Samples.Kinect.BodyBasics
{
    class BD
    {
       ...
       public void insertar (string idlectura, string nombre,float headx,float heady,float headz,float neckx,float necky,float neckz, float hipleftx,float hiplefty, float hipleftz, float footleftx,float footlefty, float footleftz,float handleftx,float handlefty,float handleftz,float hiprightx,float hiprighty,float hiprightz,
